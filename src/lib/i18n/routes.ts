...
export const routeSegments: Record<Locale, Record<RouteKey, string>> = {
  en: { home: '', products: 'products', brands: 'brands', blogs: 'blogs', recipes: 'recipes', contact: 'contact', customerContact: 'contact/customer', supplierContact: 'contact/supplier' },
  vi: { home: '', products: 'products', brands: 'brands', blogs: 'blogs', recipes: 'recipes', contact: 'contact', customerContact: 'contact/customer', supplierContact: 'contact/supplier' },
};
