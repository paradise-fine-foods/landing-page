...
export const ui: Record<Locale, UiCopy> = {
  en: {
    ...
    catalog: { eyebrow: 'Demo catalog', title: 'Professional ingredients', description: 'Search and filter a representative bilingual product range.', searchLabel: 'Search products', searchPlaceholder: 'Search by name or application', categoryLabel: 'Category', brandLabel: 'Brand', applicationLabel: 'Application', allCategories: 'All categories', allBrands: 'All brands', allApplications: 'All applications', clearFilters: 'Clear filters', resetFilters: 'Reset filters', resultSingular: 'product found', resultPlural: 'products found', noResultsTitle: 'No products match these filters', noResultsDescription: 'Try a broader search or reset the filters to see the full demo range.' },
